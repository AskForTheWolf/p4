...
class RecipeCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipe_comment" do
    assert_difference('RecipeComment.count') do
      post recipe_comments_url, params: { recipe_comment: { body: @recipe_comment.body, title: @recipe_comment.title } }
    end
  ...
  test "should update recipe_comment" do
    patch recipe_comment_url(@recipe_comment), params: { recipe_comment: { body: @recipe_comment.body, title: @recipe_comment.title } }
